  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved address as @address" do
        ...
        post :create, {:address => { "state" => "invalid value" }}, valid_session
        assigns(:address).should be_a_new(Address)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested address" do
        ...
        Address.any_instance.should_receive(:update_attributes).with({ "state" => "MyString" })
        put :update, {:id => address.to_param, :address => { "state" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the address as @address" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Address.any_instance.stub(:save).and_return(false)
        put :update, {:id => address.to_param, :address => { "state" => "invalid value" }}, valid_session
        assigns(:address).should eq(address)
      end
