  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved deck as @deck" do
        ...
        post :create, {:deck => { "nome" => "invalid value" }}, valid_session
        assigns(:deck).should be_a_new(Deck)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested deck" do
        ...
        Deck.any_instance.should_receive(:update_attributes).with({ "nome" => "MyString" })
        put :update, {:id => deck.to_param, :deck => { "nome" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the deck as @deck" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Deck.any_instance.stub(:save).and_return(false)
        put :update, {:id => deck.to_param, :deck => { "nome" => "invalid value" }}, valid_session
        assigns(:deck).should eq(deck)
      end
