...
describe ReunioesController do
  ...
  let(:valid_attributes) { { "projeto_id" => "1" } }

  # This should return the minimal set of values that should be in the session
  # in order to pass any filters (e.g. authentication) defined in
  # ReunioesController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all reunioes as @reunioes" do
      reuniao = Reuniao.create! valid_attributes
      get :index, {}, valid_session
      assigns(:reunioes).should eq([reuniao])
    end
  end
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved reuniao as @reuniao" do
        ...
        post :create, {:reuniao => { "projeto_id" => "invalid value" }}, valid_session
        assigns(:reuniao).should be_a_new(Reuniao)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested reuniao" do
        reuniao = Reuniao.create! valid_attributes
        # Assuming there are no other reunioes in the database, this
        # specifies that the Reuniao created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        Reuniao.any_instance.should_receive(:update).with({ "projeto_id" => "1" })
        put :update, {:id => reuniao.to_param, :reuniao => { "projeto_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the reuniao as @reuniao" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Reuniao.any_instance.stub(:save).and_return(false)
        put :update, {:id => reuniao.to_param, :reuniao => { "projeto_id" => "invalid value" }}, valid_session
        assigns(:reuniao).should eq(reuniao)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the reunioes list" do
      reuniao = Reuniao.create! valid_attributes
      delete :destroy, {:id => reuniao.to_param}, valid_session
      response.should redirect_to(reunioes_url)
    end
  end
