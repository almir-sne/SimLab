...
class ProjetosControllerTest < ActionController::TestCase
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post :create, projeto: { data_de_inicio: @projeto.data_de_inicio, descricao: @projeto.descricao, horas_totais: @projeto.horas_totais, name: @projeto.name, valor: @projeto.valor }
    end
  ...
  test "should update projeto" do
    put :update, id: @projeto, projeto: { data_de_inicio: @projeto.data_de_inicio, descricao: @projeto.descricao, horas_totais: @projeto.horas_totais, name: @projeto.name, valor: @projeto.valor }
    assert_redirected_to projeto_path(assigns(:projeto))
  end
